...
<div class="row">
	...
	<div class="col-md-4">
		<img src="<?php echo base_url(); ?>/public/assets/images/staff.jpg" alt="Staff" class="img-right img-rounded">
	</div>
</div>
	...
	<div class="row">
		...
		<div class="col-sm-4">
			...
			<?php echo form_open('index.php/staff/dashboard/updatecode','id="reset"'); ?>
		...
		?>
			<br>
			<a href=" <?php echo base_url('index.php/staff/allnotice'); ?> " class="btn btn-primary " role="button">All Notice</a>
		</div>
		...
		<div class="col-sm-8">
			...
			<?php echo form_open('index.php/staff/dashboard/addNotice','id="noticeForm"'); ?>
				<div class="form-group">
					<label>Title</label>
				...
				<input type="hidden" name="postby" value="staff">
