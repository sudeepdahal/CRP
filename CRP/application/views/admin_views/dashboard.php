...
<div class="row">
	...
	<div class="col-md-4">
		<img src="<?php echo base_url(); ?>/public/assets/images/admin.jpg" alt="Account" class="img-right img-rounded">
	</div>
</div>
	<div class="row">
		...
		<div class="col-sm-4">
			...
			<?php echo form_open('index.php/admin/dashboard/updatecode','id="reset"'); ?>
			...
			<?php 
			$seg=$row->nid;
			$segments = array('index.php/admin/notice', 'detail', $seg);
			?>
			...
			<br>
			<br>
			<a href=" <?php echo base_url('index.php/admin/allnotice'); ?> " class="btn btn-primary " role="button">All Notice</a>
		</div>
		...
		<div class="col-sm-8">
			...
			<?php echo form_open('index.php/admin/dashboard/addNotice','id="noticeForm"'); ?>
				<div class="form-group">
					<label>Title</label>
