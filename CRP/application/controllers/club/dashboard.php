...
class Dashboard extends CI_Controller{
	...
	public function index()
	{
		...
		//$note['notef']=$this->club_model->getNotification();

		$note = array('notef'	=> $this->club_model->getNotification(),
					   'sucmsg'	=> ""
						);
		...
		public function addNotice()
		{
			...
			$status = $this->club_model->addNotice($notice);
		...
		public function updatecode()
		{
			...
			$status = $this->club_model->updatecode($uid,$sec_code);
			if ($status == true) {
				$this->load->view('templates/header');
			 	$this->load->view('templates/club_nav',$data);
         		$this->load->view('club_views/dashboard',$note);
