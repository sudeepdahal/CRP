...
class Dashboard extends CI_Controller{
	...
	public function index()
	{
		...
		//$note['notef']=$this->exam_model->getNotification();
		$note = array('notef' => $this->exam_model->getNotification(),
					  'sucmsg' => ""	
					  );	
		...
		if(isset($email) && $type=="exam")
		{
        	...
        	$this->load->view('exam_views/dashboard',$note);
		...
		public function addNotice()
		{
			...
			//print_r($notice);
			$status = $this->exam_model->addNotice($notice);
		...
		public function updatecode()
		{
			...
			$status = $this->exam_model->updatecode($uid,$sec_code);
