...
class Dashboard extends CI_Controller{
	...
	public function index()
	{
		...
		//$note['notef']=$this->admin_model->getNotification();

		$note = array('notef'	=> $this->admin_model->getNotification(),
					   'sucmsg'	=> ""
						);
		...
		if(isset($email) && $type=="admin")
		{
        	...
        	$this->load->view('admin_views/dashboard',$note);
		...
		public function addNotice()
		{
			...
			$status = $this->admin_model->addNotice($notice);
		...
		public function updatecode()
		{
			...
			$status = $this->admin_model->updatecode($uid,$sec_code);
			if ($status == true) {
				$this->load->view('templates/header');
				$this->load->view('templates/admin_nav',$data);
        		$this->load->view('admin_views/dashboard',$note);
